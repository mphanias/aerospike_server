...
def test_openmetricsv2_check(aggregator, dd_run_check, instance_openmetrics_v2, mock_http_response):
    ...
    check = AerospikeCheck(AerospikeCheck.__NAMESPACE__, {}, [instance_openmetrics_v2])
    dd_run_check(check)
    ...
    _test_check_from_v7(aggregator, dd_run_check, instance_openmetrics_v2, mock_http_response, metric_to_check)
