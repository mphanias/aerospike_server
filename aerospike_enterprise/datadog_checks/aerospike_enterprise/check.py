...
class AerospikeEnterpriseCheckV2(OpenMetricsBaseCheckV2, ConfigMixin):
    __NAMESPACE__ = 'aerospike'

    DEFAULT_METRIC_LIMIT = 0

    def __init__(self, name, init_config, instances):
        super(AerospikeEnterpriseCheckV2, self).__init__(name, init_config, instances)
        
        # print("\n\n **** \t param-instances \n\n\t", instances,"\n\n\t param-instances[0] ", instances[0], "\n\n")
